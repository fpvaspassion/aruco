...
def handle_status(msg):
	print "[STATUS_TEXT]"+dir(msg)

def handle_meminfo(msg):
	atributes = dir(msg)
	print "[MEMINFO]"
	print dir(msg)
...
def main():
	...
	if opts.device is None:
		...
		print("Usage:")
		print("--baudrate      - communication speed(default: 115200)")
		print("--device        - serial device")
		print("--rate          - requested stream rate(default:4)")
		print("--source-system - MAVLink source system for this GCS(default: 255)")
		sys.exit(1)
